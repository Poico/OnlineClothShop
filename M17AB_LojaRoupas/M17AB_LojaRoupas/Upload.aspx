<%@ Page Title="" Language="C#" MasterPageFile="~/Modelo.Master" AutoEventWireup="true" CodeBehind="Upload.aspx.cs" Inherits="M17AB_LojaRoupas.WebForm5" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container p-5">
        ...
        <div class="mb-3">
            ...
            <asp:FileUpload class="form-control" runat="server" ID="jogoMainImg" CssClass="form-control-file" />
        </div>
        <div class="mb-3">
            <label for="exampleFormControlTextarea1" class="form-label">Descrição</label>
            <textarea class="form-control" id="Descrisao" rows="3" runat="server"></textarea>
        </div>
        <button type="button" class="btn btn-secondary btn-lg" runat="server" onserverclick="Unnamed_ServerClick">Submit</button>
    </div>
